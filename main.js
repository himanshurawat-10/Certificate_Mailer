...
const CLIENT_ID = '418586980177-6tfhl5ho12uc329lh1vp0a8hj5sbjn3t.apps.googleusercontent.com'
const CLIENT_SECRET = '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'
const REDIRECT_URI = 'https://developers.google.com/oauthplayground'
const REFRESH_TOKEN = '1//04p601D0UISBECgYIARAAGAQSNwF-L9Ir7vv2JSZrs2KE3JK4ad1vQUidjRS1TauxHM2SWFplNrkbfae4qrIP-ddDCKcVWaHtLmc'
...
async function sendMail(subject, body, name, userEmail, certiPath) {
    ...
    try {
        ...
        let mailOptions = {
            from: 'Himanshu Rawat <hrwt1234@gmail.com>',
            to: userEmail,
            subject: subject,
            text : 'hello' ,
            html: "Dear " + name + "\n" + body,
